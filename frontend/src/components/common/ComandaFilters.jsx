      ...
      <AccordionDetails>
        <Box sx={{ width: '100%' }}>
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, 1fr)', md: 'repeat(3, 1fr)', lg: 'repeat(4, 1fr)' }, gap: 2 }}>
            ...
            <Box>
              <TextField fullWidth label="Comanda" value={filters.comanda} onChange={handleInputChange('comanda')} placeholder="Buscar por comanda..." type="text" size="small" />
            </Box>
            <Box>
            ...
            <Box>
              <TextField fullWidth label="Funcionário" value={filters.funcionario_id} onChange={handleInputChange('funcionario_id')} placeholder="Buscar por funcionário..." type="number" size="small" />
            </Box>
            <Box>
              <TextField fullWidth label="Cliente" value={filters.cliente_id} onChange={handleInputChange('cliente_id')} placeholder="Buscar por cliente..." type="number" size="small" />
            </Box>
            <Box>
